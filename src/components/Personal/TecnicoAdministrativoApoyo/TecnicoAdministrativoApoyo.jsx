...
const TecnicoAdministrativoApoyo = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setData([
        ...
        { nombre: "p", apellido: "Lopez", area: "Administración" },
        { nombre: "aría", apellido: "Lopez", area: "Administración" },
        { nombre: "Mría", apellido: "Lopez", area: "Administración" },
        { nombre: "Maía", apellido: "Lopez", area: "Administración" },
        { nombre: "Mara", apellido: "Lopez", area: "Administración" },
        { nombre: "Marí", apellido: "Lopez", area: "Administración" },
        { nombre: "Ma", apellido: "Lopez", area: "Administración" },
        { nombre: "arí", apellido: "Lopez", area: "Administración" },
        { nombre: "Mía", apellido: "Lopez", area: "Administración" },
        { nombre: "Mar", apellido: "Lopez", area: "Administración" },
  ...
  return (
    <div className="personal-section-container">
      <header className="personal-section-header">
          <h1 className="personal-section-title">Tecnico, Administrativo y de Apoyo</h1>
...
export default TecnicoAdministrativoApoyo;