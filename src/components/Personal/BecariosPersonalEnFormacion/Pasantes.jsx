...
const Pasantes = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setData([
        { nombre: "Gabriel", apellido: "Oyarzo", horas: "10hs" },
        { nombre: "Valentino", apellido: "Chiappini", horas: "12hs" },
        { nombre: "P", apellido: "Chiappini", horas: "12hs" },
      ]);
      setLoading(false);
    }, 500);
  }, []);
  ...
  if (loading) {
    return (
      <div className="personal-section-container">
        <div className="personal-loading">Cargando pasantes...</div>
      </div>
    );
  }
  ...
  return (
    <div className="personal-section-container">
      <header className="personal-section-header">
        <h1 className="personal-section-title">Pasantes</h1>
      ...
      <div className="personal-content-wrapper">
        ...
        <div className="personal-cards-grid">
          {currentPersonas.map((p, i) => (
            <CardPersonal key={i} index={i} persona={p} />
          ))}
        </div>
